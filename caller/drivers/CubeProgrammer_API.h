 ...
 * \return 0 if the Stack was started successfully, otherwise an error occurred.
 */
 ...
 * \return 0 if the update was performed successfully, otherwise an error occurred.
 */
 ...
 * \return 0 if the activation was done successfully, otherwise an error occurred.
 */
int antiRollBack();
 ...
 * \return 0 if the FUS operator was started successfully, otherwise an error occurred.
